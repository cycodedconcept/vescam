...
String login = "/login";
String loginLoading = "/loginLoading";
String signup = "/signup";
String signupLoading = "/signupLoading";
String forgotPassword = "/forgotPassword";
String signUpVerify = "/signUpVerify";
String signUpSuccess = "/signUpSuccess";
String forgotPasswordVerify = "/forgotPasswordVerify";
String pinLogin = "/pinLogin";

String dashboard = "/dashboard";

String supportScreen = "/supportScreen";
String otherSettingsScreen = "/otherSettingsScreen";
...
String searchForMechanicScreen = "/searchForMechanicScreen";
String searchMechanicLoadingScreen = "/searchMechanicLoadingScreen";
String searchMechanicInputScreen = "/searchMechanicInputScreen";
String bookATowScreen = "/bookATowScreen";
String searchForTowScreen = "/searchForTowScreen";
String searchTowLoadingScreen = "/searchTowLoadingScreen";
String searchTowInputScreen = "/searchTowInputScreen";
...
String liveLocationScreen = "/liveLocationScreen";
