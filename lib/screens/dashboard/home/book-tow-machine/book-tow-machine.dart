...
class BookTowMachineScreen extends StatelessWidget {
  const BookTowMachineScreen({super.key});
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  Get.toNamed(searchForTowScreen);
                                },
                                child: Container(
                                  height: 32,
                                  width: 32,
